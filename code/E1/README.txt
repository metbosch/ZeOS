...
* libjp1.a: Test suite for the first submission code. It contains the user calls
  ...
  execute them.  
* README_E1.txt: shows the exact output that you should see from one of the tests 
  in libjp1.a 

*** Usage:

* You have to create a soft link named libjp.a pointing to the library with the
  tests that you want to run (libjp1.a). Modify the Makefile so the user target
