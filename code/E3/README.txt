...
* libjpsemaphores.a: Test suite for testing the semaphores code. It contains the user calls
  'runjp' and 'runjp_rank' to execute the tests plus all the necessary code to
  execute them.  
* libjpclone.a: Test suite for testing the clone code. It contains the user calls
  'runjp' and 'runjp_rank' to execute the tests plus all the necessary code to
  execute them.  
* README_E3.txt: this file specifies the pre-requisites for each test in libjpsemaphores.a.  
